...
class SharedAccountsModel(Base):
    ...
    id_owner = Column(Integer, ForeignKey('users.id', ondelete='CASCADE', onupdate='CASCADE'), nullable=False)
    id_member = Column(Integer, ForeignKey('users.id', ondelete='CASCADE', onupdate='CASCADE'), nullable=False)
    id_account = Column(Integer, ForeignKey('user_accounts.id', ondelete='CASCADE', onupdate='CASCADE'), nullable=False)
